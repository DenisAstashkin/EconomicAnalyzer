...
def clean_number(value):
    """Преобразует строковое представление числа (с пробелами, запятыми, %) во float"""
...
def parse_ticker_data(ticker):
    """
    Загружает страницу https://smart-lab.ru/q/{ticker}/f/y/
    и возвращает DataFrame с показателями (строки) по годам (столбцы).
    """
